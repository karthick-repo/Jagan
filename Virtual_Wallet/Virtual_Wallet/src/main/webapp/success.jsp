...
<br>
<div id="success-message"><h1 style="color:green"><span>&#x2611;</span>Virtual Card Created</h1></div>
<hr>
<div id="error" style="color: red; text-align: center">${error}</div>
<%CardEntity card=(CardEntity)session.getAttribute("card");%>
...
<label style="font-size:12px;color:gray">Expiry Month/Year</label><br>
